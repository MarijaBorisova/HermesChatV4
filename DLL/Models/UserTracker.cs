...
namespace DLL.Models
{
    ...
    public class UserTracker : IUserTracker
    {
        ...
        public Task AddUserAsync(HubCallerContext context, UserInformation user)
        {
        ...
        public async Task<IEnumerable<UserInformation>> GetAllOnlineUsersAsync() => 
            await Task.FromResult(onlineUserStore.Values.AsEnumerable());
        ...
        public Task RemoveUserAsync(HubCallerContext context)
        {
            throw new NotImplementedException();
        }
    }
